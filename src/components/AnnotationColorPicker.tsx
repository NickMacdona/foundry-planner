...
export function AnnotationColorPicker({ selectedId }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-y-2 gap-x-1 min-w-0">
      ...
      <div className="flex items-center gap-1.5 pl-2 ml-1 border-l border-slate-700">
        <span
        ...
        <input
          ...
          spellCheck={false}
          placeholder="#rrggbb"
          className="w-[88px] min-w-0 bg-slate-950 border border-slate-700 rounded px-1.5 py-0.5 text-xs font-mono text-slate-100 outline-none focus:border-indigo-400"
          maxLength={7}
        />
      </div>
    </div>
